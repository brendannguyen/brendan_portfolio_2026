...
import { ExternalLink, ExternalLinkIcon } from "./animate-ui/icons/external-link"
...
// delay, image, title, description, chip, button link, button tooltip text
